...
function receivedMessage(event) {
  ...
  if (messageText) {
	...
	//.replace(/[^\w\s]/gi, '').trim().toLowerCase()
    switch (messageText) {
      case 'szia':
      case 'help':
      case 'hi':
      case 'hello':
        sendTextMessage(senderID, 'Mondj egy magyar vagy külföldi celebet, és megmondom a FB oldalát!');
        break;
      ...
      case 'policy':
      case 'privacy policy':
	  case 'Mire való ez a bot?':
         sendTextMessage(senderID, 'Itt találod az adatvédelmi nyilatkozatot: https://datadatbot.tk/privacypolicy/myfbceleb_adatnyilatkozat.html');
        break;
    ...
    sendTextMessage(senderID, "Bocs, csak szöveges üzenetekkel foglalkozom.");
  }
}
...
function receivedPostback(event) {
  ...
  sendTextMessage(senderID, "Mondj egy celebet, és megmondom a FB oldalát.");
}
